...
@Component({
  selector: 'app-importadora-home',
  templateUrl: './importadora-home.component.html',
  styleUrls: ['./importadora-home.component.scss'],
  providers: [DatePipe]
})
export class ImportadoraHomeComponent implements OnInit {
...
dataEgresos: EgresoFijoImportadoraCuota[] = [];
...
calendarOptions!: CalendarOptions;
  ...
  getEgresos() {           
    this.importadoraService.buscarCuotas().subscribe((egresos: EgresoFijoImportadoraCuota[]) => {            
  ...
  mostrar(arg: any){
    ...
    this.importadoraService.openDialogRegistrarPago(idCuota);    
  }
