...
export class AdministracionService {
  ...
  // Metodo que permite abrir un Dialog (Modal)
  openDialogEditUsuario(): void {
    const dialogRef = this.dialog.open(DialogUsuariosEditarComponent, {})
    dialogRef.afterClosed().subscribe((res) => {})
  }

  // Metodo que permite abrir un Dialog (Modal)
  openDialogEditRol(): void {
    const dialogRef = this.dialog.open(DialogRolesEditarComponent, {})
    dialogRef.afterClosed().subscribe((res) => {})
  }
